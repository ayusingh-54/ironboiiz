...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # for training (Note: in train_ironboiiz.py, we mannually tune the training protocol, but you can also use following setting by modifying the code in ironboiiz_model.py)
